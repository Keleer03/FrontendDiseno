  ...
  <v-form ref="formDeposito" v-model="valid" lazy-validation>
    <v-container>
      <v-row>
        <v-col cols="12">
          <v-card class="pa-3 blue lighten-2">
            <h1 class="white--text">Realizar Depósito con Cambio de Moneda</h1>
          </v-card>
        </v-col>
      </v-row>
      <v-row>
        ...
        <v-col cols="12" md="6" class="pa-2">
          <v-text-field
            ...
            required
          />
          <!-- Debe ser el que se saca de la p[agina del banco] -->>
        </v-col>
        <v-col cols="12" md="6" class="pa-2">
          <v-text-field
      ...
      <v-row>
        ...
        <v-col cols="6" class="pa-2">
          <v-btn color="primary" @click="submitForm">Realizar Depósito</v-btn>
        </v-col>
      </v-row>
